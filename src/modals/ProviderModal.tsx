                    ...
                    <Card.Body>
                        <Card.Text>
                            ...
                            <ol className="list-group list-group-numbered">
                                <li className="list-group-item">There are two ways how to use Solid App: either by picking a provider or by <a href="https://solidproject.org//self-hosting/css" target="_blank" className="link-primary">hosting your own POD <AiOutlineLink /></a>.</li>
                                <li className="list-group-item">To learn more about different aspects of provider's PODs (server location, implementation) go<a href="https://solidproject.org/users/get-a-pod#get-a-pod-from-a-pod-provider"
                                    target="_blank" className="link-primary"> here<AiOutlineLink /></a>.</li>
